 ...
 * with our CHANNEL_ID before sending a notification.
 */
...
/*
 * A Kotlin extension function for AndroidX's NotificationCompat
 * that sends our Geofence entered notification.
 * It sends a custom notification based on the name string associated
