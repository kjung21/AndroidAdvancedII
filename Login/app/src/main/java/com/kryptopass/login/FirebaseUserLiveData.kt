 ...
 * This may be undesirable or expensive depending on the nature of your LiveData object,
 * but is okay for this purpose since we are only adding and removing the authStateListener.
 */
class FirebaseUserLiveData : LiveData<FirebaseUser?>() {
    ...
    // start observing FirebaseAuth state to see if there is currently a logged in user
